...
The scope/key default to this homework's own secret (homework-3/lakebase-url,
...
SCOPE = os.environ.get("LAKEBASE_SECRET_SCOPE", "homework-3")
...
def is_configured() -> bool:
    ...
    Lets the MCP server skip tool-call logging entirely during local runs that
    have no database, instead of failing a lookup on every single tool call.
    """
    return bool(
